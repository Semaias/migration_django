...
# aqui vão os campos das ´companies´ banco da kfs
  ...
  has_active               = models.SmallIntegerField(default=0)
  has_active_contacts      = models.SmallIntegerField(default=0)
  has_satisfacao           = models.SmallIntegerField(default=0)
  ...
  integrated_confirmations = models.SmallIntegerField(default=0)
